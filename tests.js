...
export function onLoad() {
    ...
    const testScores = [
        ...
        { prisPar: EuxOuNous.NOUS, capot: null, score: 71, belote: EuxOuNous.NOUS }, //litige
    ...
    for (const s of testScores) {
        ...
        let calculs = calculerScores();
        addConsole("totaux= "+JSON.stringify(calculs.totaux));
        if(calculs.is500atteind) addConsole("IL Y A 500");
        i++;
        addConsole('----------------------------------------------------------');
    }
